    ...
    subMenus: [
      {
        ...
        tasks: [
          ...
          },
          {
            ...
            description: 'Prisma 모델, CRUD API, localStorage→DB',
            descriptionJa: 'Prismaモデル、CRUD API、localStorage→DB',
            priority: 'HIGH', status: 'completed', progress: 100,
            subTasks: [
              ...
              { id: 'sl-2-4', title: 'SNS 필드 삭제 완료', titleJa: 'SNSフィールド削除完了', status: 'completed' },
            ],
            tags: ['Prisma', 'API (100%)'],
          },
          {
